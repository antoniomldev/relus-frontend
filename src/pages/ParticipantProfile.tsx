                        ...
                        <div className="w-full max-w-[480px] flex flex-col gap-6">
                            ...
                            <div className="flex flex-col items-center gap-4">
                                <div
                                    ...
                                    style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuD7XBTXmC_mL2ZcTsX57QMTb0VMiMkpeuzIw9HNMNUb7O9FMHoUvxqn1xOZK1D6_HKRmw0iVNiNcv-4Z4mWd_1_4fEbRkweG_lX06LUq9x5x877EZLXfiGClyW6gaVwWuibLET3euUmgW5tBNaiNEzyCXUkE8HA_7ZUxYSyzgnVKoScIsQxAw15m4nJF_gd_i8LGuT3b2-MemUISDCYAGroWgnMwrypT1tcekJnryU7IdxmJGM6J8o1r8A2iT-eMvvEDfTpTTFG84tC")' }}
                                ></div>
                                <div className="flex flex-col items-center">
                                    <p className="text-[28px] font-bold leading-tight tracking-[-0.015em] text-center">Samuel Rivers</p>
                            ...
                            <div className="px-4">
                                <label className="flex flex-col w-full">
                                    <p className="text-sm font-medium leading-normal pb-2 text-[#637588] dark:text-gray-400">Instagram Handle</p>
                            ...
                            <div className="w-full bg-[#fbbf24]  py-4 shadow-md">
                                <h3 className="text-center text-[#111418] text-xl font-black tracking-widest">YELLOW TEAM</h3>
                            </div>
                                    ...
                                    <div className="p-4 flex flex-col gap-4">
                                        <div className="flex justify-between items-center">
                                            <div>
                                                ...
                                                <p className="text-lg font-bold text-[#111418] dark:text-white">Room 102</p>
                                            </div>
                                        ...
                                        <div className="flex justify-between items-center">
                                            <div>
                                                ...
                                                <p className="text-lg font-bold text-[#111418] dark:text-white">John Doe</p>
                                            </div>
                                            <div className="bg-primary/10 p-2 rounded-lg text-primary">
